...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Graph widget demo",  0                ,   0,   0, 240, 320, FRAMEWIN_CF_MOVEABLE },
  { GRAPH_CreateIndirect,     0,                   GUI_ID_GRAPH0    ,   5,   5, 230, 175 },
  ...
  { SLIDER_CreateIndirect,    0,                   GUI_ID_SLIDER0   ,  60, 205,  60,  16 },
