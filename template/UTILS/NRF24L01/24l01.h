...
#define NRF24L01_CE_LOW			GPIO_ResetBits(NRF24L01_GPIO,NRF24L01_Pin_CE);
#define NRF24L01_CSN_HIGH		GPIO_SetBits(NRF24L01_GPIO,NRF24L01_Pin_CSN);
#define NRF24L01_CSN_LOW		GPIO_ResetBits(NRF24L01_GPIO,NRF24L01_Pin_CSN);
#define READ_NRF24L01_IRQ 	GPIO_ReadInputDataBit(NRF24L01_GPIO,NRF24L01_Pin_IRQ)
//24L01发送接收数据宽度定义
