...
void Flash::write(u32 WriteAddr,void *_data,u16 _NumToWrite)
{
	u32 secpos;	   //扇区地址
	...
	u16 * pBuffer;
	u16 NumToWrite;
	NumToWrite=_NumToWrite/2+_NumToWrite%2;
	pBuffer=(u16 *)_data;
...
//pBuffer:数据指针
//NumToWrite:半字(16位)数
void Flash::read(u32 ReadAddr,void *_data,u16 _NumToRead)
{
	u16 i;
	u16 * pBuffer;
	u16 NumToRead;
	pBuffer=(u16 *)_data;
	NumToRead=_NumToRead/2+_NumToRead%2;
